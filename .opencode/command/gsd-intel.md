...
Intel system is disabled. To activate:
  ...
  node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs
