...
<execution_context>
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/workflows/session-report.md end-to-end.
</process>
