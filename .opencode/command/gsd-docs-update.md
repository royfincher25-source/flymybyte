...
<execution_context>
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/workflows/docs-update.md end-to-end.
