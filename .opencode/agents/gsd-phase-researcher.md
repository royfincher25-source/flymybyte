...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
