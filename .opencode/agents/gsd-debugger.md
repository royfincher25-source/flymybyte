...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = H:/disk_e/dell/FlyMyByte/.opencode
                  → checks H:/disk_e/dell/FlyMyByte/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done
                  → writes to H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/hooks/
...
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
