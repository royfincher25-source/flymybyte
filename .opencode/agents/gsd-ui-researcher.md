...
Use template from `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
