...
<reference>
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/user-profiling.md` to load:
