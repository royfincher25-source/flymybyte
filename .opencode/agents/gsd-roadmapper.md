...
Reference full template: `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/state.md`.
