...
@H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/thinking-models-execution.md
...
**See @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/checkpoints.md**
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/summary.md
...
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
