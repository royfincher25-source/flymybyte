...
<!-- For checkpoint task examples and patterns, see @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/checkpoints.md -->
...
See `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
