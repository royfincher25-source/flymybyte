...
Key references:
- @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md" "H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.backup.md"
```
...
✓ Stores profile at H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md
...
Run session scan:
```bash
SCAN_RESULT=$(node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs scan-sessions --json 2>/dev/null)
```
...
```bash
SAMPLE_RESULT=$(node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs profile-sample --json 2>/dev/null)
```
...
- The user-profiling reference doc at `H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/references/user-profiling.md
...
**Get questions:**
```bash
QUESTIONS=$(node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --json 2>/dev/null)
```
...
```bash
ANALYSIS_RESULT=$(node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs profile-questionnaire --answers "$ANSWERS_PATH" --json 2>/dev/null)
```
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs write-profile --input "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Profile written to H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to H:/disk_e/dell/FlyMyByte/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs generate-dev-preferences --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```

Display: "✓ Generated /gsd-dev-preferences at H:/disk_e/dell/FlyMyByte/.opencode/commands/gsd/dev-preferences.md"

**For AGENTS.md profile section (if selected):**

```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --json 2>/dev/null
```
...
```bash
node H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/bin/gsd-tools.cjs generate-claude-profile --analysis "$ANALYSIS_PATH" --global --json 2>/dev/null
```

Display: "✓ Added profile section to H:/disk_e/dell/FlyMyByte/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.backup.md"
```
...
Your profile:    H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   H:/disk_e/dell/FlyMyByte/.opencode/commands/gsd/dev-preferences.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        H:/disk_e/dell/FlyMyByte/.opencode/AGENTS.md
```
