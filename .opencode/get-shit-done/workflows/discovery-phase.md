...
See H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/discovery.md
...
Use H:/disk_e/dell/FlyMyByte/.opencode/get-shit-done/templates/discovery.md.
