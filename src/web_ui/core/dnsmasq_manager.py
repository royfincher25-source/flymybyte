...
class DnsmasqManager:
    ...
    def generate_bypass_config(self) -> Tuple[bool, str]:
        ...
        Генерирует ipset=/domain/ipset_name директивы для автоматического
        добавления IP в ipset при DNS запросах.
        ...
        try:
            ...
            logger.info(f"Generated bypass config: {total_domains} domains -> {len(all_domains)} ipsets")
            return True, f"Generated {total_domains} domains across {len(all_domains)} ipsets"
        except Exception as e:
